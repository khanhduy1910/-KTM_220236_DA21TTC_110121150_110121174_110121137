                        ...
                        <div class="item">
                            <a href="{{ url('category/'.$prod->category->slug.'/'.$prod->slug) }}">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 style="text-align:center; color:black;">{{ $prod->name }}</h5>
                                        <span style="font-size: 20px; " class="float-end">{{ number_format($prod->selling_price) }} VNĐ</span>                                
                                        @if($prod->original_price > 0)
                                            <span style="font-size: 20px;" class="float-start text-muted mr-2">
                        ...
                        <div class="item">
                            <a href="{{ url('category/'.$tcategory->slug)}}">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 style="text-align:center; color:black;">{{ $tcategory->name }}</h5>
                                        <p style="text-align:center;">
                                            <i>{{ $tcategory->description }}</i>
                                        </p>
                                    </div>
                                </div>
                            </a>
