...
@section('content')
    ...
    <div class="py-3 mb-4 shadow-sm bg-light border-top">
            <div class="container">
                <h6 class="mb-0">                 
                    <a style="font-size: 16px;" href="{{ url('category/'.$products->category->slug) }}" class="text-decoration-none text-secondary">{{ $products->category->name}}</a> /
                    <a href="{{ url('category/'.$products->category->slug.'/'.$products->slug) }}">
                    <span style="font-size: 18px;" class="text-dark">{{ $products->name}}</span>
                    </a>         
                </h6>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-3">
                            ...
                            <br><label for="Quantity">Số lượng</label>
                            <div class="input-group text-center mb-3">
                                <button style="height: 38.5px; width: 38.5px; text-align: center;" class="input-group-text decrement-btn"> - </button>
                                <input type="text" name="quantity " class="form-control qty-input text-center" value="1" >
                                <button style="height: 38.5px; width: 38.5px; " class="input-group-text increment-btn"> + </button>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <br>
