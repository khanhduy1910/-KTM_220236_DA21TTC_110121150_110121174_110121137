        ...
        <div class="card shadow ">
            @if (count($cartitems) > 0 )
                    ...
                    <div class="row product_data">
                        ...
                        <div class="col-md-2 my-auto">
                            ...
                            <div class="input-group text-center mb-3" style="width: 130px;">
                                <button style="height: 38.5px; width: 38.5px; " class="input-group-text changeQuantity decrement-btn"> - </button>
                                <input type="text" name="quantity" class="form-control qty-input text-center" value="{{$item->prod_qty}}" >
                                <button style="height: 38.5px; width: 38.5px; " class="input-group-text changeQuantity increment-btn"> + </button>
                            </div>
                ...
                <div class="card-footer">
                    <h5> Tổng tiền: <span style="font-size:25px; color: green;" class="total_price">{{ number_format($total) }}</span> VNĐ
